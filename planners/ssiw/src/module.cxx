...
BOOST_PYTHON_MODULE( libssiw )
{
	class_<Sketch_SIW_Planner>("Sketch_SIW_Planner")
		.def( init< std::string, std::string, std::string, bool >() )
		...
		.def( "create_negated_fluents", &Sketch_SIW_Planner::create_negated_fluents_ext )
		...
		.def( "set_sketch_name", &Sketch_SIW_Planner::set_sketch_name)
		.def( "set_use_goal_counter", &Sketch_SIW_Planner::set_use_goal_counter)
